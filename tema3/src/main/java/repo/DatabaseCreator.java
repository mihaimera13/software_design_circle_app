...
public class DatabaseCreator {
    ...
    public void fillTableQuestions(String filename) {
        QuestionsPersistence questionsPersistence = new QuestionsPersistence();
        createTableQuestions();

        String alterQuery = "TRUNCATE questions RESTART IDENTITY";
        try{
            Persistence persistence = new Persistence();
            persistence.executeQuery(alterQuery);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            while(question!=null){
                ...
                questionsPersistence.insertQuestion(ques);
